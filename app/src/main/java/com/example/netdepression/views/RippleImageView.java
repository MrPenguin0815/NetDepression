package com.example.netdepression.views;
...
public class RippleImageView extends RelativeLayout {
    ...
    private float imageViewHeight=IMAMGEVIEW_SIZE;
    ...
    private void getAttributeSet(Context context, AttributeSet attrs) {
        ...
        imageViewHeight = typedArray.getDimension(R.styleable.custume_ripple_imageview_imageViewHeigth, IMAMGEVIEW_SIZE);
